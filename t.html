...
<body>
    <header>
        <div class="header-content">
            ...
            <img src="/storage/emulated/0/Pictures/Photoroom/1000157841 (2).png" alt="Your Profile Picture" class="profile-picture">
            <h1>Tamil Selvan P</h1>
    ...
    <section id="resume">
        ...
        <div class="section-content">
            <center>
            <h2>Resume</h2>
            <a href="MyResume.pdf" target="MyResume.pdf" class="download-button">Download CV</a>
        </center>
        </div>
